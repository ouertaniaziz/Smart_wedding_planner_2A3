...
void MainWindow::on_search_clicked()
{
    ...
    if(ui->musid->text()!="" && nom_mus!="")
    {
        ui->tableView_3->setModel(mscs.afficher_mus(nom_mus,id_mus,-1));
    }
}
...
void MainWindow::on_Submit_mus_clicked()
{
...
void MainWindow::on_mus_man_main_5_clicked()
{
    ui->IDERROR->setText("");
    ui->PRERROR->setText("");
    ui->PRMedit->clear();
...
void MainWindow::on_returnsami_clicked()
{
...
void MainWindow::on_returnsami_4_clicked()
{
    ui->stackedWidget->setCurrentIndex(33);
}

void MainWindow::on_returnsami_3_clicked()
{
    ui->stackedWidget->setCurrentIndex(34);
}

void MainWindow::on_returnsami_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(34);
}

void MainWindow::on_Submit_mus_2_clicked()
{
...
void MainWindow::on_returnsami_6_clicked()
{
    ui->stackedWidget->setCurrentIndex(36);
}

void MainWindow::on_mus_man_main_6_clicked()
{
...
void MainWindow::on_returnsami_13_clicked()
{
    ui->stackedWidget->setCurrentIndex(36);
}

void MainWindow::on_mus_man_main_7_clicked()
{
    ui->stackedWidget->setCurrentIndex(39);
}

void MainWindow::on_emp_man_main_clicked()
{
    ui->stackedWidget->setCurrentIndex(40);
}

void MainWindow::on_search_8_clicked()
{
    int id_emp=0;
    ...
    if(ui->empid->text()!="" && nom_emp!="")
    {
        ui->tableView_7->setModel(empy.afficher_emp(nom_emp,id_emp,-1));
    }
}
...
void MainWindow::on_returnsami_14_clicked()
{
    ui->stackedWidget->setCurrentIndex(40);
}
...
void MainWindow::on_sub_emp_2_clicked()
{
    ...
    if(id_emp==0 || salaire_emp==0 || numlen>8 || numlen <8)
    {
        ...
        if(id_emp==0)
        {
            ui->IDERROR_5->setText("Please Enter a number");
...
void MainWindow::on_mus_man_main_16_clicked()
{
    ui->stackedWidget->setCurrentIndex(43);
}

void MainWindow::on_mus_man_main_17_clicked()
{
    ui->stackedWidget->setCurrentIndex(44);
}

void MainWindow::on_mus_man_main_18_clicked()
{
